...
const addTokenToWallet = (tokenSymbol, tokenAddress) => async () => {
  if (window.ethereum) {
    ...
    // NOTE (appleseed): 33T token defaults to sLDAO logo since we don't have a 33T logo yet
    let tokenPath;
...
function OhmMenu() {
  ...
  const SLDAO_ADDRESS = addresses[networkID].SLDAO_ADDRESS;
  const LDAO_ADDRESS = addresses[networkID].LDAO_ADDRESS;
  ...
  return (
    ...
    >
      <Button id="ohm-menu-button" size="large" variant="contained" color="secondary" title="LDAO" aria-describedby={id}>
        <SvgIcon component={InfoIcon} color="primary" />
        <Typography>LDAO</Typography>
      </Button>
            ...
            <Fade {...TransitionProps} timeout={100}>
              <Paper className="ohm-menu" elevation={1}>
                <Box component="div" className="buy-tokens">
                  <Link
                    href={`https://pancakeswap.finance/swap?inputCurrency=${usdtAddress}&outputCurrency=${LDAO_ADDRESS}`}
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  {/* <Link
                    href={`https://swap.spiritswap.finance/#/add/${USDC_ADDRESS}/${LDAO_ADDRESS}`}
                    target="_blank"
                    rel="noreferrer"
                  >
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                  ...
                  {/* <Link href={`https://abracadabra.money/pool/10`} target="_blank" rel="noreferrer">
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">
                        Wrap sLDAO on Abracadabra <SvgIcon component={ArrowUpIcon} htmlColor="#A3A3A3" />
                      </Typography>
                    </Button>
                  </Link> */}
                </Box>
                ...
                {/* <Box component="div" className="data-links">
                  ...
                  <Link href={`https://dune.xyz/shadow/Olympus-(LDAO)`} target="_blank" rel="noreferrer">
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">
                ...
                {isEthereumAPIAvailable ? (
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("LDAO", LDAO_ADDRESS)}>
                        <SvgIcon
                          component={ohmTokenImg}
                          viewBox="0 0 100 100"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">LDAO </Typography>
                      </Button>
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("sLDAO", SLDAO_ADDRESS)}>
                        <SvgIcon
                          component={sOhmTokenImg}
                          viewBox="0 0 100 100"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">sLDAO</Typography>
                      </Button>
                    </Box>
                  </Box>
                ) : null}
