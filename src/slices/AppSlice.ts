...
export const loadAppDetails = createAsyncThunk(
  ...
  async ({ networkID, provider }: IBaseAsyncThunk, { dispatch }) => {
    ...
    const sHecMainContract = new ethers.Contract(addresses[networkID].SLDAO_ADDRESS as string, sOHMv2, provider);
    const hecContract = new ethers.Contract(addresses[networkID].LDAO_ADDRESS as string, ierc20Abi, provider);
